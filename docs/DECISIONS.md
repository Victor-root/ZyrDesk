...
**Ce que ça ne change pas.** L'écran d'ouverture qui dit « Connexion perdue, reprise en cours… » reste ce qui parle quand la session est vraiment tombée ([D174](#d174-une-session-qui-tombe-ne-coûte-plus-la-session-2026-09-09-pendant-m6)) : les voyants couvrent ce qui vient avant, l'image qui hoquette et celle qui se fige. La barre de mesures du menu flottant lit le même fichier et montre les quatre nombres à qui veut le détail. Et le voyant ne dit pas lequel des deux ordinateurs coince : le journal le dit, et la barre de mesures le montre.
