...
**Ce qui va avec : plus aucune touche coincée.** Si le clavier part vers l'image pendant qu'une modificatrice est enfoncée et qu'il lui est repris avant qu'elle ne remonte, l'ordinateur distant ne voit jamais le relâchement et croit la touche tenue pour toujours ; tout ce qui est tapé ensuite y arrive en Alt et une lettre, ce qui ne fait rien et ressemble trait pour trait à un clavier mort. Dit par Victor : « j'ai même carrément perdu le clavier dans la session ». Chaque fois que le clavier revient à l'image après en être parti, ZyrDesk relâche donc là-bas toutes les modificatrices qu'aucun doigt ne tient, lues sur le clavier physique et nulle part ailleurs.
