...
## D137. Deux interrupteurs d'essai sur le fil : le marquage ECN et le port fixe (2026-09-04, pendant M6)

**Le relevé, sans VPN cette fois.** Les deux ordinateurs en direct par leurs adresses publiques, le serveur n'ayant servi qu'à la rencontre. Deux silences en douze minutes, de quatre puis de dix secondes, des deux côtés à la fois, route directe et relais ensemble ; le relais entend les deux ordinateurs dès qu'ils se tournent vers lui, mais ce que chacun lui confie n'atteint pas l'autre avant plusieurs secondes. Le transport corrigé en [D136](#d136-le-transport-ne-retient-plus-rien-tant-que-la-connexion-vit-2026-09-04-pendant-m6) a passé le premier silence et rien n'a été jeté pendant le second ; le moteur client a renoncé à sa dixième seconde. Le même relevé au débit le plus bas donne les mêmes silences. Et un autre produit, sur les mêmes machines et les mêmes box, n'en voit aucun.

**Ce qu'on ne peut plus dire.** Ni le Proxmox, ni le WireGuard, ni le serveur, ni le débit : tous ont été sortis du chemin ou changés sans que rien ne change. Ce qui reste est entre les deux cartes réseau, et se distingue de l'autre produit par la forme de nos paquets. Deux différences sont à portée d'un essai.
...
**Et dite dès l'ouverture, pas seulement par la veille.** Deux curseurs pendant les six premières secondes de chaque session : le journal donne la ligne exacte, « curseur d'en face non réglé : aucune session en cours ». La fenêtre ne peut nommer la voie qu'une fois le service convaincu que la session existe, ce qui arrive plusieurs secondes après que l'image est à l'écran ; jusque-là elle n'avait rien à nommer et ne pouvait rien dire. Or l'ouverture, elle, tient la voie en main depuis le début : c'est elle qui l'a demandée. Le curseur d'en face est donc réglé là, dans la même respiration que les enceintes et l'écran, avant même que le lecteur ne démarre. La veille continue derrière, pour les changements de mode.
...
## D158. Le mode jeu n'avait jamais marché, et la cause est celle du clavier (2026-09-06, pendant M6)

**Le relevé.** « Toujours pas de curseur en mode jeu. » Puis, une fois la question posée dans le bon sens : sur l'écran de l'ordinateur d'en face, en mode jeu, **son curseur ne bouge pas du tout**, et cliquer d'abord dans l'image ne change rien. Ce n'était donc jamais une histoire de curseur : le curseur ne bougeait pas parce que la souris ne partait pas. « Honnêtement, la souris en mode jeu je ne l'ai pratiquement jamais testée, et je crois que ça date depuis un moment. »

**La cause, lue dans le code des deux bouts.** Un jeu se joue au mouvement et non à l'endroit, donc le moteur client demande à sa bibliothèque d'affichage le mode souris relatif, et elle demande au système le mouvement propre de la souris sur le canal brut que Windows tient pour ça. Sa boucle de messages jette tout paquet de ce canal qui arrive à une fenêtre dont elle croit qu'elle n'a pas le clavier, et ce qu'elle croit se lit à une seule chose : sa fenêtre est-elle celle que le système appelle le premier plan. Or l'image est portée dans notre fenêtre pour toute la session, donc elle est un enfant, et le système donne le premier plan au chef de famille et jamais à un membre. La réponse est non du premier instant à la fin, et rien ne peut la rendre vraie : lui donner le focus n'y change rien, la bibliothèque ne regarde pas le focus. **La totalité des mouvements d'un mode jeu était jetée à l'intérieur de la bibliothèque, avant que rien ne quitte l'ordinateur.**

**C'est exactement le défaut de [D43](#d43-les-touches-du-système-ont-un-seul-propriétaire-et-ce-peut-être-le-moteur-2026-08-24-pendant-m4), un étage plus bas.** Le clavier se décidait au même endroit et pour la même raison, ce qui a coûté P-M10 et [../docs/CLAVIER.md](CLAVIER.md). La souris n'avait jamais été regardée : le mode bureau, lui, passe par les messages ordinaires, qui vont à la fenêtre sous la main quel que soit le premier plan, donc il marchait et masquait entièrement l'autre.

**Ce qui a été fait, en deux moitiés qui ne sont pas au même endroit.** Le mouvement est lu par le moteur, au seul endroit où les messages de sa fenêtre passent avant la bibliothèque, celui que P-M10 avait posé, avec le drapeau que Windows offre pour ce cas précis : l'entrée demandée en nommant la fenêtre, livrée même quand cette fenêtre n'est pas devant. Et seulement ce que la bibliothèque s'apprête à jeter, pour qu'un Moonlight ordinaire ne joue pas au double de la vitesse de la main. C'est P-M14, et le plafond du moteur client passe de onze à douze.

**L'autre moitié ne pouvait pas y être.** Le mode relatif enferme aussi le pointeur de l'ordinateur qui regarde sur un point de l'image, sans quoi, caché et libre, il s'en va derrière la main qui joue : ce qu'il survole prend les clics, et sur un bureau à deux écrans il quitte simplement l'image. La bibliothèque décide ça de la même réponse et ne l'a donc jamais fait non plus. Mais le système ne laisse enfermer le pointeur qu'au programme du premier plan, et ce programme, c'est ZyrDesk. La cage est donc posée par ZyrDesk, redite à chaque tour de la veille parce que c'est une chose partagée de tout le bureau, et rendue dès que la souris cesse d'être celle d'un jeu, que le menu s'ouvre ou que la session s'arrête.

**Corrigé le jour même, sur relevé : deux pointeurs d'une seule main, et un menu inatteignable.** Le mouvement lu est celui de l'appareil et ne doit rien à l'endroit où se trouve le pointeur. En fenêtré, une main descendue sur la barre des tâches de l'ordinateur qui regarde y emmenait son pointeur **et** continuait de conduire celui d'en face. Et le bouton flottant était injoignable : ouvrir son menu essayait de sortir la session du mode jeu en tapant la combinaison du moteur dans l'image, ce qui demande de lui donner le clavier d'abord, refusé quatre fois de suite sur la séance qui l'a montré (« le focus a été refusé à l'image », « pointeur non rendu »). Cette mécanique changeait en plus un mode que personne n'avait demandé à changer. Elle est retirée : le moteur ne lit le mouvement que tant que la fenêtre sous le pointeur est la sienne, donc une main sur le bouton flottant, sur son menu ou sur la barre des tâches ne conduit plus rien, et ouvrir le menu n'a plus qu'à ouvrir la cage. Le mode de la souris reste où il est, et l'entrée qui en change est dans ce menu, comme avant.

**Et les clics, trouvés au relevé suivant.** « En mode jeu je ne peux pas cliquer mais j'ai bien ma souris. » En mode souris relatif la bibliothèque d'affichage ignore volontairement les messages de fenêtre qu'envoie un clic : elle compte les recevoir sur le canal brut, à côté du mouvement, et c'est précisément le canal qu'elle jette pour une fenêtre dont elle croit qu'elle n'a pas le clavier. Personne ne lisait donc les boutons, et le premier correctif n'avait lu que le mouvement. Ils sont lus au même endroit et rendus au moteur sous forme de ses propres événements, pour que l'inversion des boutons et l'attente accordée au premier clic d'un bureau aient encore lieu. Et le pointeur est posé sur le bouton flottant quand son menu s'ouvre en mode jeu : un jeu cache le pointeur au-dessus de l'image et seulement là, donc un pointeur libéré au milieu de l'image devait la traverser sans être vu pour atteindre la seule sortie d'une session.
...
## D160. Une session éjectée attendait le silence du moteur pour s'en apercevoir (2026-09-06, pendant M6)

**Le relevé.** « Quand j'ai fait la croix pour interrompre, ça marche, mais côté client ça fige et ça met du temps avant de réellement sortir, genre il pense que c'est un plantage de l'hôte en me disant que la session s'est arrêtée sur une erreur, alors que non, c'est juste moi qui l'ai kick. » — trouvé en testant, juste après coup, la fonction même que [D159](#d159-le-service-oubliait-qui-le-contrôlait-à-linstant-même-où-il-le-lisait-2026-09-06-pendant-m6) venait d'ajouter.

**Ce que la fermeture volontaire fait, et que l'éjection ne faisait pas.** Fermer par la croix pose d'abord un drapeau local (« c'est voulu »), avant même de parler au réseau, puis arrête elle-même le lecteur si l'ordinateur d'en face ne répond pas à temps. L'attente bloquante sur ce lecteur se débloque alors tout de suite, lit le drapeau, et revient à l'accueil sans un mot d'erreur. L'éjection, elle, ne posait ce drapeau nulle part et n'arrêtait rien : elle ferme seulement la connexion, côté service. Le seul moyen que le lecteur avait de s'en apercevoir restait le sien propre, un canal de contrôle à lui qui ne se déclare muet qu'après trente secondes de silence. Vu d'ici, ça ressemblait donc exactement à une panne.

**Où se lit la disparition, et où elle ne se lisait pas encore.** La veille du bouton flottant demande une fois par seconde au service ce qu'il tient pour vrai, mais une session qui vient de commencer n'y est pas tout de suite : le temps que le service l'inscrive, la fenêtre se fie à ce qu'elle a écrit elle-même en démarrant le lecteur, tant que ce lecteur répond encore. Cette place de secours, faite pour les premières secondes, ne s'efface jamais d'elle-même : une voie disparue du service en cours de route s'y retrouvait donc tout autant qu'une voie qui n'y est pas encore montée, les deux se lisant comme « le lecteur tourne toujours », et la veille ne regardait que ça.

**Corrigé en retenant, une fois, si le service avait fini par la confirmer.** La veille garde maintenant en mémoire si la voie qu'elle suit a, ne serait-ce qu'une fois, été vue par le service. Une voie qui l'a été et qui ne l'est plus, alors que le lecteur croit toujours tourner, ne peut plus vouloir dire autre chose qu'une session terminée d'ailleurs : une éjection, ou l'un des réglages qui ferment déjà tout aujourd'hui (marquage ECN, port fixe, hébergement désactivé). La veille pose alors elle-même le drapeau « c'est voulu » et arrête le lecteur, exactement comme le fait la croix de la fenêtre : le même chemin, pris un instant plus tôt par quelqu'un d'autre. Une voie qui n'a jamais été confirmée ne déclenche rien, ce qui laisse intacte la place de secours des premières secondes ; et un lecteur qui s'arrête tout seul pour une vraie raison locale, la voie restant alors inscrite au service jusqu'au bout, continue de le dire comme avant.
...
## D165. L'aiguilleur choisissait une route sans jamais savoir si elle portait quoi que ce soit (2026-09-07, pendant M6)

**Le relevé.** Trois connexions envoyées coup sur coup, journaux des deux ordinateurs à chaque fois. Le premier montre une route élue qui a répondu à ses propres sondes sans faillir une seule fois pendant toute la durée de la session, une trentaine de secondes, avant que la voie ne se ferme d'elle-même : « way 1 closed, 0 packets into the tunnel, 0 of them onto the wire ». Le deuxième montre l'autre issue de la même route qui ne répond qu'à ses sondes : le client abandonne au bout de quinze secondes (« no way to PC-SAV : PC-SAV n'a répondu ni en direct ni par le relais en 15 secondes »), et l'hôte voit sa connexion rompue « aborted by peer : the application or application protocol caused the connection to be closed during the handshake », le mot que laisse une poignée de main qui n'a jamais pu se terminer. Le troisième finissait par réussir, mais seulement après un nouvel essai bien plus lent que d'habitude : « ça me le fait souvent aussi quand je réessaye, et ça a fini par se connecter. » C'est ce troisième journal, où le mot ajouté par [D163](#d163-le-tunnel-tient-mais-son-tout-premier-mot-au-moteur-ne-disait-jamais-sil-était-entendu-2026-09-07-pendant-m6) apparaît enfin en abondance, qui a montré où regarder : la session avait fini par passer, longtemps après avoir choisi une première route.

**Ce qu'une sonde prouve, et ce qu'elle ne prouve pas.** L'aiguilleur qui choisit la route entre deux ordinateurs (`crates/zyr-transport/src/junction.rs`) le fait en s'envoyant à lui-même, chaque seconde, un petit signal de test, et en retenant celles de ses routes qui répondent. C'est tout ce qu'il regarde : jamais si la vraie conversation, la session elle-même, progresse réellement sur la route choisie. Une route peut donc répondre parfaitement à ces sondes tout en bloquant, plus loin sur le trajet, le passage de la session elle-même : rien ne le voyait, et rien ne s'en dégageait jamais tout seul, la route continuant de répondre aux sondes indéfiniment. Et dans l'autre sens, une route qui vient tout juste de faire ses preuves avec la session pouvait perdre sa place au profit d'une autre route, jamais essayée, pour la seule raison qu'elle répondait un rien plus vite à une sonde.

**Ce que ça explique.** Les trois relevés à la fois : une route qui semble bonne et qui, pourtant, ne mène nulle part, sans que rien ne le remarque ; le premier échange réel qui reste bloqué dessus sans limite de temps propre, puisqu'il attend une route que rien ne vient jamais corriger ; et la lenteur du second essai, la session ayant fini par réussir seulement une fois qu'une autre route, par hasard, a fini par être retenue à la place.

**Corrigé en donnant à l'élection une mémoire de ce qui a vraiment servi.** Chaque route retient maintenant si du vrai trafic, pas une sonde, l'a traversée au moins une fois : la preuve qu'une sonde seule ne pouvait jamais apporter. Une route en service depuis vingt secondes qui n'a toujours rien porté de réel perd le bénéfice du doute que sa sonde lui donnait, et cède la place à la meilleure des autres routes qui répondent, plutôt que d'être gardée indéfiniment sur la seule foi d'un écho (ce délai valait quatre secondes à l'écriture de cette décision ; voir [D166](#d166-le-délai-de-la-preuve-coupait-des-connexions-qui-auraient-fini-par-réussir-2026-09-07-pendant-m6), qui l'a corrigé le jour même). À l'inverse, une route que du trafic réel a déjà traversée n'est plus délogée par une inconnue de la même sorte tant que celle-ci n'a rien prouvé à son tour, quelle que soit sa mesure : la preuve l'emporte sur une sonde plus rapide. Rien de tout cela ne touche à la règle déjà en place entre le direct et le relais, le second cédant toujours la place au premier dès qu'il répond, preuve ou non : cette règle-là ne s'appuyait déjà sur aucune marge.

## D166. Le délai de la preuve coupait des connexions qui auraient fini par réussir (2026-09-07, pendant M6)

**Le relevé, le jour même de D165.** « Bon ben là je peux même plus me connecter. » Le journal montre une carte dont la route élue change presque toutes les quatre secondes, indéfiniment, sans qu'aucune ne porte jamais rien de réel, jusqu'à l'abandon au bout de quinze secondes : exactement le délai que [D165](#d165-laiguilleur-choisissait-une-route-sans-jamais-savoir-si-elle-portait-quoi-que-ce-soit-2026-09-07-pendant-m6) venait de poser.

**Le mal que le remède portait en lui.** Quatre secondes suffisent à repérer une route qui répond aux sondes sans jamais rien porter, mais une connexion qui s'ouvre pour la première fois n'a pas encore prouvé quoi que ce soit non plus, pour la raison la plus ordinaire : sa poignée de main n'a pas fini. Le mécanisme ne distinguait pas les deux cas et traitait la seconde comme la première : une route à peine élue, à qui la poignée de main demandait encore quelques secondes, se voyait retirée pour une autre qui n'avait rien mesuré, laquelle repartait de zéro et se faisait retirer à son tour avant d'avoir eu sa chance. Une connexion qui aurait fini par réussir, un peu lentement, n'avait plus la moindre chance d'y arriver.
...
## D170. Une route redevenue bonne ne suffisait pas à réveiller la connexion (2026-09-07, pendant M6)

**Le relevé.** Dans le journal du client, une carte reste sur une seule route élue pendant toute une coupure : « nothing has come from the far computer for several seconds » à 19:47:48, puis deux silences du socket lui-même, chacun repris une seconde ou quelques secondes plus tard (« not one packet has been given to the socket for 1000 ms » suivi de « the socket is being given packets again », à 19:47:49 puis de nouveau à 19:48:05), sans qu'aucune bascule de route n'ait lieu entre les deux : la route élue à 19:47:48 est toujours la même vingt-quatre secondes plus tard. La session s'écroule pourtant : « way 1 towards PC-SAV: the tunnel stopped, connexion impossible : timed out » à 19:48:12, trente secondes tout rond après le dernier paquet réel reçu, la limite d'inactivité de ce transport.

**Ce que ça isole.** La route elle-même allait bien : ses propres sondes recommençaient à être entendues dès 19:47:49, longtemps avant la fin. Ce n'est donc ni [D165](#d165-laiguilleur-choisissait-une-route-sans-jamais-savoir-si-elle-portait-quoi-que-ce-soit-2026-09-07-pendant-m6) ni [D168](#d168-la-preuve-dune-route-ne-survivait-pas-à-sa-propre-disparition-2026-09-07-pendant-m6) : la route en service n'a cette fois jamais été ni punie ni changée. C'est exactement la piste que [D169](#d169-une-poignée-de-main-qui-traîne-bloquait-la-porte-à-tout-le-monde-2026-09-07-pendant-m6) laissait ouverte : la connexion elle-même, au-dessus de la route, n'avait aucune raison de retenter quoi que ce soit avant la fin de son propre délai.

**Ce que quinn fait tout seul, et pourquoi ça ne suffisait pas ici.** Un paquet envoyé et resté sans accusé de réception fait grandir, à chaque nouvelle perte, le délai avant le prochain essai : un aller-retour, puis deux, puis quatre, et ainsi de suite. Ce délai n'a aucune raison de se raccourcir quand la route redevient bonne, puisque le changement de route est invisible pour quinn par construction, exactement comme [D169](#d169-une-poignée-de-main-qui-traîne-bloquait-la-porte-à-tout-le-monde-2026-09-07-pendant-m6) le disait déjà. Le tenir jusqu'au bout finit par réussir sur une coupure assez courte ; sur celle-ci, il n'en a pas eu le temps.

**Corrigé en donnant à la connexion un signal qu'elle n'avait aucun autre moyen d'obtenir.** L'aiguilleur sait, lui, quand sa route élue répond de nouveau après un silence : c'est justement ce que ses propres sondes, indépendantes de la connexion, viennent de vérifier. Dès que ça arrive, la connexion reçoit un petit paquet qui ne demande rien et n'attend rien, envoyé pour la seule raison de forcer un accusé de réception : c'est cet accusé, une fois reçu, qui remet le délai de quinn à zéro sans attendre qu'il y arrive tout seul. Le signal est pris une fois et effacé aussitôt, pour ne pas répéter un retour déjà signalé ; il ne se déclenche que pour la route qui porte vraiment la session, jamais pour une autre qui flanche en arrière-plan sans rien y changer.
...
## D173. Une carte qui avait fait ses preuves ne les reperdait plus jamais (2026-09-08, pendant M6)

**Le relevé.** `reach.log` et son pendant distant, tout juste livrés par D172, ont montré une session de dix-neuf minutes s'écrouler pour une coupure de six secondes, côté PC-VICTOR seulement (« said nothing in 1000 ms » de 17:49:25 à 17:49:31, PC-SAV n'ayant rien vu). Le journal du service raconte la suite : la route élue depuis dix-neuf minutes est donnée pour morte, celle du relais prend sa place un instant, puis une troisième, à une adresse jamais essayée, s'installe à 17:49:35 et y reste, répondant à chaque sonde. Mais plus une seule image n'y passe : le journal du lecteur montre la dernière avant la coupure, puis rien, jusqu'à ce que son canal de contrôle (ENet, dans le moteur) déclare forfait à 17:50:00, trente secondes tout rond après le dernier octet réel, entraînant tout le reste avec lui, y compris PC-SAV trente secondes plus tard à son tour.

**Ce que ça isole.** Ni le tunnel ni les deux moteurs n'étaient en cause : la patience unique du produit ([D138](#d138-la-patience-dune-session-est-un-seul-nombre-et-les-moteurs-ne-décident-plus-seuls-2026-09-04-pendant-m6)) tenait ses trente secondes des deux côtés, exactement comme prévu, et le réveil de connexion ([D170](#d170-une-route-redevenue-bonne-ne-suffisait-pas-à-réveiller-la-connexion-2026-09-07-pendant-m6)) est bien parti. Le mal était plus haut : la troisième route, celle restée en service jusqu'au bout, n'a jamais rien porté de réel, et rien dans l'aiguilleur n'avait plus le droit de le remarquer.

**Ce que [D168](#d168-la-preuve-dune-route-ne-survivait-pas-à-sa-propre-disparition-2026-09-07-pendant-m6) avait rendu permanent.** Ce fichier retient depuis D168 si une carte a, une fois dans sa vie, laissé passer du vrai trafic (`ever_proven`), pour ne plus jamais reprendre une route à une carte qui a déjà fait ses preuves, quel que soit le temps qu'elle a passé à ne rien porter depuis. C'était juste le soir où D168 a été écrite : la carte venait de prouver du trafic quatre minutes plus tôt. Ce soir, la carte avait fait ses preuves dix-neuf minutes avant une coupure qui, elle, a duré bien plus que les six secondes de la panne elle-même : plus rien de réel n'est jamais revenu, pour une raison que ce fichier ne connaît pas, et l'exemption écrite pour protéger une reprise de quelques secondes a protégé une route morte pendant une demi-heure.

**Corrigé en bornant la grâce plutôt qu'en l'accordant pour toujours.** La carte retient maintenant depuis quand du vrai trafic l'a traversée pour la dernière fois (`proven_since`), et non plus seulement si ça lui est arrivé. Une carte encore dans `PROVEN_WITHIN` de sa dernière preuve reste protégée exactement comme avant, ce qui couvre la coupure de quelques secondes que D168 avait en tête sans y toucher. Passé ce délai, elle est jugée comme n'importe quelle carte qui n'aurait jamais rien prouvé : sa route en service doit avoir, elle aussi, laissé passer du vrai trafic depuis qu'elle est élue, ou céder la place à la meilleure des autres qui répondent. Les deux tests de D168 sont repris avec un vrai écart de quelques secondes entre la preuve et la coupure plutôt que des instants confondus, et un test ajouté rejoue exactement ce soir : une carte prouvée depuis longtemps, une route qui prend la suite sans jamais rien porter, la levée de l'exemption une fois `PROVEN_WITHIN` passé depuis la dernière preuve réelle.

**Ce que ça ne change pas.** Rien de plus court que `PROVEN_WITHIN` ne change de sens : une carte jamais prouvée continue de juger sa route dans le même délai qu'avant, et une route qui a fait ses preuves une fois garde son abri tant qu'elle reste élue, peu importe le temps passé. Ni l'élection ordinaire ni la limite d'inactivité de trente secondes n'ont bougé non plus : cette dernière reste le filet de sécurité pour une coupure trop longue pour que ce mécanisme, ou tout autre, la rattrape à temps.

## D174. Une session qui tombe ne coûte plus la session (2026-09-09, pendant M6)

**Le relevé.** « La session a fait que de se couper aujourd'hui, c'était super chiant. Et dans les mêmes conditions je n'ai pas d'emmerdes avec Parsec, donc faut faire quelque chose, parce que ZyrDesk est franchement incroyable, mais si au final il est inutilisable ça sert à rien. » Les deux relevés de la journée disent le décor sans ambiguïté : PC-SAV perd Internet huit fois entre 13:09 et 16:50, cinq à dix secondes à chaque fois, soit une coupure toutes les vingt-cinq minutes environ ; PC-VICTOR, en face, pas une seule.

**Ce que huit correctifs en quatre jours n'ont pas réglé.** [D165](#d165-laiguilleur-choisissait-une-route-sans-jamais-savoir-si-elle-portait-quoi-que-ce-soit-2026-09-07-pendant-m6) à [D173](#d173-une-carte-qui-avait-fait-ses-preuves-ne-les-reperdait-plus-jamais-2026-09-08-pendant-m6) visent tous la même chose : rendre imperdables les trente secondes de patience que [D138](#d138-la-patience-dune-session-est-un-seul-nombre-et-les-moteurs-ne-décident-plus-seuls-2026-09-04-pendant-m6) donne à une session. Chacun a corrigé un vrai défaut et chacun a rendu ces trente secondes un peu plus solides. Mais c'est une course qui ne se gagne pas : il suffit d'une coupure un peu trop longue, ou d'un enchaînement qu'on n'a pas prévu, et tout est perdu d'un coup. Le produit jouait la session entière sur un seul jet de dés, toutes les vingt-cinq minutes.

**Ce que fait le produit auquel on nous compare.** Parsec ne traverse pas mieux les coupures : il ne les paie pas. Il affiche « reconnexion », refait le lien tout seul, et rend l'écran quelques secondes plus tard. La différence n'est pas dans la solidité du transport, elle est dans ce que coûte un échec.

**Corrigé en reprenant l'image au lieu de rendre la main.** Une session qui s'arrête sans que personne l'ait demandé ne renvoie plus à l'accueil : la fenêtre reste, l'écran d'ouverture revient avec « Connexion perdue, reprise en cours… », et tout le chemin est refait tout seul, comme la personne le refaisait à la main toute la soirée. Une nouvelle réunion au serveur s'il en faut une, des routes sondées depuis rien, un moteur relancé, l'image reposée dans la même fenêtre. Le fil qui conduit la session sait déjà rouvrir l'image sans finir la session, c'est ce que fait un réglage qu'un moteur distant ne peut pas prendre où il est : la reprise emprunte exactement ce chemin-là.

**Ce qui la borne, et pourquoi deux comptes.** Cinq reprises d'affilée, une session qui a tenu une minute remettant le compte à zéro : une session qui retombe aussitôt cinq fois n'est pas un réseau qui hoquette, c'est un réseau qui ne la porte pas en ce moment, et le dire vaut mieux qu'un écran qui ne se pose jamais. Les reprises qui n'arrivent même pas à ouvrir sont comptées à part et seulement deux, parce qu'elles coûtent une demi-minute chacune, le service demandant déjà deux fois de lui-même ([D171](#d171-une-première-tentative-qui-échoue-laissait-la-personne-recliquer-elle-même-2026-09-08-pendant-m6)) : un ordinateur éteint est ainsi annoncé au bout d'une minute et non de trois. Trois secondes d'attente avant chaque essai, parce que l'ordinateur d'en face a son propre ménage à faire quand son client disparaît, et qu'il ne l'apprend parfois qu'une demi-minute plus tard, par sa propre patience.

**Ce qui n'est pas repris.** Une session que l'ordinateur d'en face raccroche proprement, une éjection, un réglage qui ferme les sessions : ce sont des décisions, pas des accidents, et la veille du bouton flottant les traite déjà comme volontaires ([D160](#d160-une-session-éjectée-attendait-le-silence-du-moteur-pour-sen-apercevoir-2026-09-06-pendant-m6)). Une première tentative qui échoue non plus : c'est le clic de la personne, elle regarde, et la réponse lui appartient. Et la croix de la fenêtre pendant une reprise arrête tout à l'instant, sans rien changer au code qui l'écoute déjà.
...
## D176. Les gestes du pavé tactile restaient sur l'ordinateur qui regarde (2026-09-10, pendant M6)

**Le relevé.** « Les raccourcis clavier et souris passent bien par le flux, en revanche quand je suis sur mon portable côté client, les raccourcis que je fais au touchpad ne sont pas transmis au flux mais encore à mon PC local. » Trois gestes sont nommés : glisser trois doigts à l'horizontale, qui change de fenêtre comme un Alt+Tab ; taper à trois doigts, qui fait un clic molette ; taper à quatre doigts, qui met en lecture ou en pause. Les trois agissent sur le portable et rien n'en sort.

**Ce que ça isole.** Rien ne les porte. Ce que parlent les moteurs connaît des touches, des boutons et un pointeur, et rien qui ressemble à une main posée à plusieurs doigts ; et Windows répond lui-même à un geste dit « global », dans son shell, avant qu'aucun programme ne se le voie proposer. Il existe une porte officielle pour qu'un programme les reçoive à sa place, `TouchpadGesturesController`, et elle est marquée expérimentale sur un contrat qu'aucun Windows publié ne porte : écrire dessus serait écrire pour une machine que personne n'a.

**Corrigé en lisant le pavé nous-mêmes.** Un pavé tactile de précision est un appareil HID ordinaire, qui raconte où est chaque doigt, et n'importe quel programme peut demander ce flux au système en nommant une fenêtre. ZyrDesk le demande pendant qu'une session est à l'écran, reconnaît lui-même les gestes, et les fait faire sur cet ordinateur-ci exactement comme une main les ferait : le geste à trois doigts posés devient un clic molette, qui part là où le pointeur est posé, donc dans l'image ; le glissement devient un Alt+Tab ; l'appui à quatre doigts devient la touche lecture/pause. Ce sont ensuite les moteurs qui les portent de l'autre côté, par le chemin de tous les jours.

**Ce que ça a demandé aux moteurs, et pourquoi.** Deux choses, toutes deux des trous du moteur client et non des besoins de ZyrDesk ([P-M15](../patches/MANIFEST.md)). Son crochet clavier, celui de P-M10, rendait au système **toute** frappe injectée par un programme : où va une touche se décide pourtant à l'endroit où est le clavier, jamais à qui l'a produite, et un Alt+Tab envoyé par le programme qui porte la fenêtre visait cette fenêtre-là exactement comme un doigt. Rendu, il changeait de fenêtre ici. Et la table qui traduit une touche pour l'ordinateur d'en face parcourt les touches de navigateur, 0xA6 à 0xAC, puis saute à 0xBA : les quatre du milieu sont précédent, suivant, arrêt, lecture/pause, celles que tout portable porte sur sa rangée de fonctions, et elles n'arrivaient nulle part. La touche lecture/pause rejoint au passage le jeu que le crochet reprend à Windows, qui l'emporte plus loin que les autres : il la remet directement à ce qui joue sur cet ordinateur, sans consulter aucune fenêtre.

**Un interrupteur, et un refus honnête.** Le menu du bouton flottant porte une ligne « Pavé tactile », entre « Cet ordinateur » et « La session ». La mettre sur la session est refusé tant que Windows répond encore à ces gestes lui-même, et ce refus est toute l'honnêteté de cet interrupteur : les deux à la fois feraient tout arriver deux fois, une fois de chaque côté, ce qui est pire que rien. Windows ne les lâche que depuis une page de ses propres réglages et aucun appel ne la remplace : les valeurs derrière cette page sont lues une fois, au fond de son entrée, et un programme qui les écrit change ce que la page affiche et rien de ce que le pavé fait. ZyrDesk les lit donc au lieu de les écrire, et ouvre la page à l'endroit où la personne doit agir : Paramètres, Bluetooth et appareils, Pavé tactile, gestes à trois doigts sur « Rien », appuis à quatre doigts sur « Rien ».

**Ce qui dépend encore du clavier.** Le glissement et la lecture/pause voyagent comme un Alt+Tab tapé à la main, par le crochet du moteur, donc seulement quand le clavier appartient à la session : ligne « Clavier », côté « Immersif ». C'est cohérent et non un oubli, un glissement voulant dire « la fenêtre suivante » et l'interrupteur d'à côté disant justement à qui les fenêtres appartiennent. Le clic molette, lui, est un clic et traverse quoi que fasse le clavier.

**Ce que ça ne change pas.** Un doigt, deux doigts et la roue passaient déjà par le flux comme une souris ordinaire et n'ont pas bougé. Le glissement à quatre doigts reste à Windows, qui change de bureau virtuel avec, et personne ne demande de le lui reprendre. Le volume et la coupure du son restent à cet ordinateur-ci : ils parlent de la pièce où la personne est assise, pas de celle qu'elle regarde, et la session a déjà son propre interrupteur de son.

## D177. L'avertissement sur le lien était peint dans l'image, et arrivait après coup (2026-09-11, pendant M6)

**Le relevé.** « Sur Parsec, quand on perd la connexion, on a un petit voyant jaune avec un symbole wifi qui nous dit que la connexion est mauvaise, et il s'affiche toujours au bon moment. Sur ZyrDesk, c'est le message rouge de Moonlight, qui est moche et en surimpression dans le flux, et en plus il a une latence de ouf : on a déjà l'image qui se fige et le message apparaît plusieurs secondes après. » Avec, une deuxième demande : Parsec montre un second voyant à côté du premier quand l'encodage ou le décodage coince sur l'un des deux ordinateurs, et il le faut aussi.

**Ce que ça isole, et c'est deux choses.** Le message est **dessiné dans l'image**, en lettres rouges de trente-six points, dans une couleur et une taille que le moteur choisit : l'image est le bureau de l'ordinateur d'en face, et rien de ce produit n'a à écrire dessus. Et il est **en retard par construction** : il vient d'un état que la bibliothèque de protocole calcule sur une fenêtre de trois secondes, et il est dessiné par le décodeur, c'est-à-dire par la partie du moteur qui n'a précisément rien à faire quand l'image est figée. Le seul endroit qui pouvait le dire est le seul qui s'arrête quand il y a quelque chose à dire.

**Corrigé en le disant nous-mêmes, et en rendant la lecture vive.** Le moteur porte déjà l'interrupteur de cet avertissement sur sa page de réglages ; c'est la ligne de commande qui n'y menait pas, seule de ses dix-sept ([P-M16](../patches/MANIFEST.md)). Une session s'ouvre maintenant en disant non, et ZyrDesk pose deux pastilles dans le coin haut gauche de l'image, à l'opposé de son bouton flottant : l'une pour le lien, l'autre pour l'image. Elles ne se montrent que quand il y a quelque chose à dire, elles ne se cliquent pas, et la fenêtre qui les porte est transparente aux clics, le coin haut gauche appartenant au bureau d'en face.

**Ce qui les rend vives.** La ligne que le moteur écrit pour qui le pilote était une fenêtre d'une seconde, écrite depuis le chemin du décodage. C'est la bonne forme pour des nombres qu'une personne lit et la mauvaise pour la question qu'une session pose à l'instant où elle s'arrête : le fichier devenait simplement vieux, et vieux se lit comme un moteur mort. Il est désormais réécrit cinq fois par seconde depuis un rappel à lui, avec un nombre de plus qui ne se moyenne pas : depuis combien de temps une image n'a pas atteint le décodeur. C'est celui-là qui allume le premier voyant, dans le tiers de seconde qui suit, avant que la main n'ait bougé la souris pour vérifier.

**Ce qui allume quoi.** Le lien : l'image figée depuis plus d'un tiers de seconde, ou deux pour cent d'images perdues en route, ou cinq pour cent arrivées trop tard pour être montrées. L'image : le temps qu'un des deux ordinateurs met par image dépasse le temps disponible, celui d'en face à l'encodage ou celui-ci au décodage. Ce temps disponible est calculé sur la cadence **mesurée** et non sur celle demandée, et c'est ce qui rend le voyant juste sans rien demander à personne : un hôte qui met vingt-cinq millisecondes par image en sert quarante par seconde, donc son encodage est exactement ce qui donne le rythme ; le même hôte à trois millisecondes sur une session à trente images a trente-trois millisecondes devant lui et ne gêne personne. Le temps de rendu, lui, n'est jamais compté : il comprend l'attente du rafraîchissement de l'écran, donc il approche toujours le temps disponible, et un voyant qui le compterait serait allumé toute la session.

**Un voyant qui tient.** Allumé à la lecture qui le dit, éteint seulement quand plus rien ne l'a dit depuis une seconde et demie. Sans ça il clignoterait : les lectures arrivent une douzaine de fois par seconde et un réseau qui va mal va mal par à-coups. Et le journal porte une ligne par allumage avec la raison, une par extinction, jamais une par lecture.

**Et la pastille dit lequel des deux ordinateurs coince.** Elle porte les deux écrans du logo du produit, celui d'en face derrière et celui-ci devant, tous deux posés en sourdine, et rallume celui qui ne suit pas ; les deux quand les deux ne suivent pas, ce qui arrive sur une session trop grande pour les deux machines. C'est le dessin de la marque, donc ça se lit sans légende, et ça tient dans les dix-huit pixels d'une icône là où un mot n'y tiendrait pas. Les deux côtés sont pesés chacun de son côté et non l'un ou l'autre : l'encodage d'en face contre le temps disponible, le décodage d'ici contre le même, et rien n'oblige à n'en nommer qu'un.

**Ce que ça ne change pas.** L'écran d'ouverture qui dit « Connexion perdue, reprise en cours… » reste ce qui parle quand la session est vraiment tombée ([D174](#d174-une-session-qui-tombe-ne-coûte-plus-la-session-2026-09-09-pendant-m6)) : les voyants couvrent ce qui vient avant, l'image qui hoquette et celle qui se fige. La barre de mesures du menu flottant lit le même fichier et montre les quatre nombres à qui veut le détail, et le journal porte la raison en toutes lettres avec les millisecondes.

## D178. Une session rangée dans la barre des tâches n'en ressortait plus (2026-09-11, pendant M6)

**Le relevé.** « Quand le stream est réduit avec le bouton réduire de la barre de titre, et que j'essaie de revenir dessus, la fenêtre est bloquée dans la barre des tâches, elle ne se rouvre pas. Si je fais clic droit, Fermer, ça revient bien au menu principal, donc l'application n'a pas planté. » Arrivé plusieurs fois. Le journal du 11 septembre porte deux lignes écrites au même instant, et c'est tout ce qu'il faut : `barre de titre active : le premier plan est à l'image` et, à la seconde d'après, `cadre de la fenêtre : fenêtre 199x34 en (-32000, -32000), intérieur 0x0`. Le second rectangle est ce que Windows répond pour une fenêtre rangée. Donc, au même moment : la fenêtre est dans la barre des tâches, et le système dit que le premier plan appartient à l'image.

**Ce que ça isole.** L'image du moteur est une fenêtre **possédée** par la nôtre : c'est ce qui la tient devant, la fait descendre avec elle et la retire de la barre des tâches et d'Alt+Tab. Le shell rattache une fenêtre possédée au bouton de celle qui la possède. Et un bouton de la barre des tâches est une bascule : si le groupe tient le premier plan, cliquer dessus **range** au lieu de rouvrir. Une fenêtre rangée dont le premier plan est resté sur l'image cachée est donc une fenêtre dont le bouton ne fait plus rien : il range ce qui est déjà rangé.

**Ce qui l'y maintenait.** Les deux programmes partagent un seul état d'entrée pendant toute une session, ce qui comprend la fenêtre active et le focus ([D43](#d43-le-clavier-narrivait-pas-à-la-session-2026-08-25-pendant-m4)). Et la veille du bouton flottant rendait le clavier à l'image **une fois par seconde, sans regarder si la fenêtre était à l'écran** : donner cet état partagé à une fenêtre que personne ne voit y laisse le premier plan, seconde après seconde, tant que la fenêtre reste en bas. `lay_it_out` pose la même question depuis toujours et y répond déjà : une fenêtre qui n'est pas à l'écran n'est pas une fenêtre sur laquelle poser quoi que ce soit. Le clavier ne la posait pas.

**Corrigé en ne rendant plus le clavier à une image que personne ne voit.** Rien n'est fait tant que la fenêtre est rangée ; remonter remet tout en place de lui-même, la veille le redisant une seconde plus tard. Et le relevé du cadre dit désormais « elle est rangée dans la barre des tâches » au lieu d'écrire un rectangle posé à moins trente-deux mille, qui se lit comme une mesure et n'en est pas une.

**Ce qui reste à prouver, et comment.** Le mécanisme ci-dessus explique tout ce que le relevé montre, mais le relevé ne contient pas le clic qui n'a rien fait : le produit n'écrivait rien sur la descente et la remontée de sa propre fenêtre. Il écrit maintenant deux lignes par aller-retour, avec ce qui tient le premier plan à cet instant. Elles départagent les deux seules explications possibles : si « ressortie de la barre des tâches » n'arrive jamais, le système ne nous a rien demandé et c'est bien la bascule du bouton ; si elle arrive et que la fenêtre reste en bas, c'est nous qui la faisons redescendre.

**Ce que ça ne change pas.** Une session continue de tourner pendant que la fenêtre est rangée, ce qui est voulu : l'ordinateur d'en face reste tenu, et la croix rend son bureau. L'image reste posée dans notre fenêtre et descend avec elle. Et le clavier revient à la session dès que la fenêtre remonte, comme après tout ce qui le lui prend.

## D179. Les deux ordinateurs partagent un presse-papiers (2026-09-11, pendant M6)

**Le besoin.** « Il me faudrait une fonctionnalité pour pouvoir faire copier-coller entre le client et l'hôte, donc presse-papiers partagé, et si possible aussi pour les images, parce que souvent j'ai besoin de copier-coller des trucs et j'ai donc aussi des images dans mon presse-papiers Windows. » C'est la course qu'on s'assoit pour faire : copier une adresse, une commande, une capture d'écran ici, et les coller là-bas.

**Aucun moteur n'est touché, et ce n'est pas un choix.** Le protocole des moteurs n'a pas de canal de presse-papiers, n'en a jamais eu et n'en aura pas : c'est un protocole de jeu, il porte une image, un son et des entrées. Le produit l'avait prévu depuis le premier jour ([ARCHITECTURE.md](ARCHITECTURE.md) §1), et c'est le canal de ZyrDesk dans le tunnel qui le porte, en version 19 de son dialecte.

**Un seul message, les deux sens.** Un presse-papiers est partagé ou il ne l'est pas, et lequel des deux ordinateurs on a copié dessus ne se décide d'aucun côté. Alors la même question porte les deux moitiés : celui qui regarde donne ce qui a été copié chez lui et redemande ce qui a été copié en face. C'est la seule question de ce canal à faire les deux à la fois, et les autres n'en avaient pas besoin : le curseur, les écrans, les codecs se demandent dans un sens.

**Ce qui rend la chose presque gratuite.** Chaque clip porte une empreinte de son contenu, et les deux bouts s'échangent l'empreinte de ce qu'ils tiennent déjà. Un presse-papiers se lit plusieurs fois par seconde et change quelques fois par heure : presque chaque tour est donc une empreinte qui part et un mot qui revient. La même empreinte empêche ce qui arrive de repartir aussitôt d'où il vient, puisque ce qu'on pose sur un presse-papiers s'y relit sous l'empreinte exacte avec laquelle il est arrivé. Et rien n'est jamais dit qui veuille dire « j'ai le presse-papiers vide, vide le tien » : un ordinateur qui ne tient rien se tait.

**Les images passent, et en PNG.** Les deux ordinateurs sont sous Windows, donc une image voyage sous la seule forme que tous leurs programmes connaissent déjà. Beaucoup en posent une eux-mêmes au presse-papiers, un navigateur par exemple, et elle est alors portée exactement telle qu'elle a été trouvée. Une capture d'écran, elle, est remise en pixels bruts, huit millions d'octets pour un grand écran, et c'est l'imagerie de Windows qui en fait un PNG de quelques centaines de milliers d'octets. Rien d'un encodeur n'est embarqué : un PNG fait par le système est un PNG que tous les programmes lisent, et un décodeur écrit ici serait un deuxième à tenir juste. Rendue, une image est posée deux fois, en PNG et en bitmap, et Windows déduit les formes plus anciennes de la seconde tout seul.

**Un plafond, et il est dit.** Cinq millions d'octets. Au-delà, ce que quelqu'un a copié tiendrait l'image de la session plusieurs secondes sur un lien qui doit porter les deux, pour coller quelque chose qu'il a presque sûrement déjà sur l'autre machine. Le journal le dit une fois, avec le poids.

**Où le presse-papiers se touche.** Un presse-papiers appartient à une station de fenêtres ; le service est assis sur une station qui n'en porte aucune, et celle qui en a une appartient à une autre session. C'est exactement l'aveuglement de la forme du curseur ([D151](#d151-la-forme-du-curseur-voyage-à-côté-de-limage-2026-09-05-pendant-m6)) et il a la même réponse : le programme du service est relancé dans la session qui tient l'écran et lit et écrit depuis là, les deux moitiés se passant des fichiers. Le même mécanisme des deux côtés, sur l'ordinateur qui regarde comme sur celui qui est regardé, parce que c'est la même question.

**Ce qui ne tourne que pendant une session.** L'assistant ne vit que tant qu'on lui demande quelque chose, et s'éteint quelques secondes après la dernière question, en emportant ce qu'il avait écrit. Un ordinateur que personne ne regarde garde son presse-papiers pour lui, et n'a même rien qui le lise.

**L'interrupteur, et pourquoi il est allumé.** Une ligne « Presse-papiers » dans le menu du bouton flottant, entre « Chacun le sien » et « Partagé ». Allumé par défaut, contrairement aux trois interrupteurs du dessus : celui-ci n'est pas un goût mais ce à quoi un bureau à distance sert, et une session qui refusait le copier-coller en silence enverrait chercher un réglage. Il reste un interrupteur parce qu'un presse-papiers est une chose privée et qu'on doit pouvoir cesser d'en partager un. La fenêtre n'y fait rien d'autre que l'écrire : le partage est l'affaire des deux services, qui relisent ce réglage à chaque tour de leur veille.

**Ce que ça ne change pas.** Les fichiers ne traversent pas : copier un fichier dans l'explorateur ne met pas le fichier au presse-papiers, il y met un chemin sur une machine où l'autre n'a rien à chercher. Un transfert de fichiers est autre chose, et ce sera autre chose. Le presse-papiers n'est pas partagé avec l'écran de connexion d'un ordinateur, qui n'a pas de session pour en tenir un. Et rien de tout cela ne passe par les moteurs, donc rien n'en dépend : la pile de correctifs reste à quatorze.

## D180. Les fichiers copiés traversent au moment du coller (2026-09-11, pendant M6)

**Le besoin.** « Je voudrais pouvoir aussi transférer n'importe quoi en copier-coller, peu importe la taille du fichier en question, mais qui ne m'interrompe pas le stream, que ça mette genre une barre de chargement dans le FAB. » [D179](#d179-les-deux-ordinateurs-partagent-un-presse-papiers-2026-09-11-pendant-m6) laissait justement les fichiers dehors : un presse-papiers ne porte pas un fichier, il porte le nom d'un fichier qui vit sur une machine où l'autre n'a rien à chercher.

**Quand les octets traversent, et c'est la décision.** Au moment du coller. Rien ne bouge quand on copie : ce qui traverse alors est la liste des noms et des poids, qui pèse quelques centaines d'octets pour cent gigaoctets nommés. Les octets ne partent que lorsque quelqu'un colle quelque part, et pas une seconde avant. Copier un dossier « pour voir » ne coûte donc rien du tout, et c'est ce qui permet de dire « peu importe la taille ».

**Ce qui tient l'image à l'écart, et ce n'est pas un réglage.** Un morceau à la fois, dans chaque sens. Un morceau est demandé, il arrive, le suivant est demandé : un fichier ne peut jamais occuper du lien plus d'un morceau de deux cent cinquante mille octets, quel que soit son poids et quelle que soit la vitesse du lien. Un lien deux fois plus rapide porte le fichier deux fois plus vite et laisse l'image exactement où elle était, parce qu'il n'y a jamais eu de file de morceaux derrière laquelle se ranger. Aucun quota, aucune priorité à régler, aucune fenêtre à accorder : la forme même de l'échange s'en charge.

**Tenir la place des fichiers, et ce que ça coûte.** Windows n'a qu'une façon de porter des fichiers qui ne sont pas encore là, et c'est celle dont se sert tout programme qui propose une pièce jointe sans l'écrire d'abord sur un disque : le presse-papiers porte une liste, et un objet rend le contenu de l'un des fichiers quand quelqu'un finit par le demander. Personne ne le demande avant de coller, et c'est exactement pour ça que se faire demander le contenu **est** le coller. Cet objet-là vit dans le programme qui l'a posé et meurt avec lui, donc l'assistant qui l'a posé ne rentre plus chez lui au bout de ses dix secondes : il reste tant que les fichiers sont au presse-papiers. C'est toute la différence avec l'assistant qui ne fait que lire, et c'est le prix des octets qui ne traversent pas avant d'être voulus.

**Un presse-papiers écrit par l'OLE se lit par l'OLE.** C'est ce qui manquait pour que la chose marche du tout. Quand l'explorateur copie des fichiers, il ne pose pas les noms sur le presse-papiers : il pose un objet, et le presse-papiers ne porte plus qu'un repère nommé « DataObject ». Un programme qui le lit à l'ancienne y voit ce repère et rien d'autre, là où les noms étaient derrière l'objet depuis le début. Alors la question se pose des deux façons : d'abord à l'ancienne, qui coûte un appel ; puis à l'OLE, seulement quand la première n'a rien rendu, celle-là réveillant le programme qui a copié. Et la ligne du journal qui dit pourquoi quelque chose n'a pas traversé nomme désormais les deux, faute de quoi elle décrit un presse-papiers vide qui ne l'est pas.

**Deux choses qu'un programme doit à un presse-papiers qu'il tient pour les autres.** Prendre sa place auprès du système en arrivant, sans quoi rien ne se pose du tout et chaque coller de ce qui aurait été offert échoue avec. Et lire ses messages pendant qu'il attend : la fenêtre que le système lui ouvre pour ça est sur son fil, les questions des autres programmes y arrivent sous forme de messages, et un fil qui ne lit jamais les siens est un coller qui attend une réponse que personne n'écoute. Les deux vont ensemble, et c'est pourquoi chacune des attentes de l'assistant répond au lieu de dormir.

**Il répond sur le fil qui demande.** L'objet se déclare `IAgileObject`, ce que tout ce qu'il tient permet : une liste que personne ne change, un dossier qu'on ne fait que lire. Sans cette déclaration, chaque question de Windows reviendrait au seul fil qui a posé l'objet, et l'attente d'une minute d'octets venus du réseau serait ce fil-là qui attend, avec le presse-papiers et le reste de l'assistant derrière lui.

**Où les octets se posent.** Dans un dossier du produit, sous ses données, et jamais directement là où la personne colle. C'est Windows qui fait cette dernière copie, à partir de ce que le produit lui tend, au moment et à l'endroit que la personne a choisis. Un produit qui écrirait de lui-même dans les Documents de quelqu'un serait un produit qui décide de ce qu'on ne lui a pas demandé. Le dossier s'en va avec la dernière session.

**Un mot dans un fichier, et il sert trois fois.** L'assistant qui tient les fichiers écrit un mot à chaque tour de sa boucle. Le mot dit si quelqu'un a collé, et le service y lit trois choses d'un coup : que le coller a eu lieu et qu'il faut aller chercher les octets ; qu'un assistant est là et qu'il ne faut pas en lancer un second à côté ; et, quand la dernière session s'en va, c'est le service qui enlève ce fichier, ce qui est sa seule façon de dire à l'assistant de lâcher le presse-papiers et de s'arrêter.

**La barre, et où elle est.** Dans la marque elle-même : la vitre de l'écran de devant se remplit comme une barre de chargement. Ni fenêtre de plus, ni second dessin posé à côté du bouton. Cette vitre-là fait vingt pixels sur douze, là où le pourtour du bouton n'en offre que deux, et tout le monde la lit déjà comme un écran. Le service écrit où il en est quand le centième change, l'interface le relit cinq fois par seconde, et le fichier disparaît quand tout est arrivé, ce qui fait disparaître la barre sans que personne ait à dire que c'est fini.

**Ce qui se voit dans l'autre sens.** Rien, sur ce bouton-ci, et c'est juste : quand c'est l'ordinateur d'en face qui colle, l'attente se voit sur son bureau, dans la fenêtre de copie que Windows y ouvre lui-même, et ce bureau-là est justement l'image qu'on regarde.

**Aucun moteur n'est touché, pour la même raison qu'en D179.** Le dialecte du canal de ZyrDesk passe en version 20, avec un verbe qui porte les deux sens comme celui du presse-papiers : un morceau qu'on tend et un morceau qu'on redemande dans la même question. La pile de correctifs reste à quatorze.
...
**La règle.** Tout ce qui est du code s'écrit en anglais : noms de fichiers et de modules, types, fonctions, variables, constantes, noms des tests, commentaires et documentation du code, jetons et classes de `crates/zyr-ui/design.css`. Les scripts suivent la même règle : installation du serveur, installateur Windows, empaquetage des moteurs, CI. Ce que la personne lit reste en français : les textes de l'interface et les messages qu'elle voit. Seule exception, l'aide des outils en ligne de commande (`--help`) : elle naît des commentaires du code, elle est donc en anglais comme leurs options, ce qu'elle était déjà pour `zyr-cli` et `zyrdeskd`. La règle est redite dans le [README](../README.md), section « Conventions du code », pour qu'une IA qui reprend le dépôt la trouve avant d'écrire une ligne.
...
## D229. La carte de l'hôte reste à pleine vitesse, et l'affichage rend la latence que la cadence avait prise (2026-09-25, pendant MZ)

**Ce que le deuxième journal a montré.** Trente secondes à travers Internet avec la cadence de [D228](#d228-les-images-saffichent-au-rythme-de-lécran-une-par-rafraîchissement-2026-09-25-pendant-mz). La fluidité est là : un rafraîchissement entre deux images presque partout, aucune image jamais vue, aucune remontrée. Mais trois choses coûtent.

- **L'encodage.** 2 ms par image pendant les deux premières secondes de chaque session, puis 7 à 10 ms jusqu'à la fin, dans les deux journaux. Même une image renvoyée à l'identique, donc sans rien à chercher, passe de 2 à 6 ms. Ce n'est pas le contenu : c'est la carte qui ralentit. Le pilote NVIDIA baisse ses fréquences dès que le bureau lui demande peu, et rien ne lui dit que chaque image est attendue. Sunshine le savait et demandait au pilote de rester à pleine vitesse (son option `nvenc_latency_over_power`, active sauf si on la coupe) ; la migration l'avait perdu.
- **La réserve.** Un tiers des secondes, chaque image attendait un rafraîchissement de plus (16,7 ms), l'écran restant régulier. Une bonne part venait des images que l'hôte renvoie quand son écran n'a pas changé : l'hôte envoie la première une période et un huitième après la précédente, donc en retard sur le rythme de l'écran, et elle prenait un rafraîchissement à elle, repoussant toutes les suivantes.
- **Le rythme de l'écran, pendant une coupure réseau.** Quelques rafraîchissements datés de travers par Windows, et le lecteur en tirait tout : un seul pour caler sa grille, un seul pas anormal pour conclure à un changement de fréquence. Il a cru à 19,6 ms par rafraîchissement au lieu de 16,7, et des images sont sorties trop tôt ou trop tard pendant plusieurs secondes.

**Ce qui change.**

- Le moteur hôte écrit dans les réglages du pilote NVIDIA un profil « ZyrDesk » pour son programme, avec « Gestion de l'alimentation » sur « Performances maximales », comme Sunshine le faisait pour le sien ([MOTEUR.md](MOTEUR.md), section 3, étape 4). Le profil ne vaut que pendant qu'une session tourne : c'est le seul moment où ce programme se sert de la carte. Il n'est écrit que s'il manque ou a changé, avant que le moteur crée son périphérique Direct3D, puisque le pilote le lit à ce moment-là. Une machine sans pilote NVIDIA n'a rien à régler et le journal n'en dit rien.
- Une image renvoyée ne fait jamais attendre une plus neuve : si elle attend encore, elle est laissée de côté dès qu'une plus neuve arrive ; si elle est déjà présentée, elle cède son rafraîchissement à une plus neuve qui arrive avant la fin de la fenêtre. Elle n'apporte rien à l'écran, elle n'y perd donc rien ([MOTEUR.md](MOTEUR.md), section 3, étape 9).
- La durée d'un rafraîchissement est la médiane des durées mesurées sur les deux dernières secondes, entre rafraîchissements distants d'une seconde environ. Le moment du dernier rafraîchissement est la médiane de ce qu'en disent les neuf derniers. Un changement de fréquence demande que la majorité des cinq derniers pas s'accordent sur une autre durée. Et le compteur de Windows est lu entre deux lectures de l'horloge distantes de 50 µs au plus, pour qu'un fil interrompu au mauvais moment ne date pas tout en retard.

**Ce qui a été pesé sur les vraies arrivées.** Les arrivées des deux journaux, image par image, ont été rejouées contre un écran simulé, à dix-sept décalages différents entre les deux écrans. Laisser les images renvoyées céder leur place retire 6,8 ms en moyenne (de 46,6 à 40,3 ms entre capture et écran) pour autant d'accrocs. La carte à pleine vitesse en retire environ 6 de plus. Deux autres idées ont été écartées sur ces chiffres. Reprendre le rafraîchissement de réserve plus vite qu'en deux secondes gagne moins d'une milliseconde et ajoute des accrocs. Sauter tout de suite une image en retard quand la suivante arrive à temps gagne 2 ms mais double les accrocs.

**Ce qui se lit dans le journal.** La ligne `pacing:` compte en plus les images renvoyées qui ont cédé leur place. Le moteur hôte écrit une ligne au début de chaque session : le pilote garde, ou garde désormais, la carte à pleine vitesse, ou pourquoi il n'a pas pu. Les étiquettes à envoyer ne changent pas ; la ligne du pilote est sous `engine`.

**Ce qui reste.** L'écart entre la capture et l'arrivée varie de 6 à 10 ms d'une image à l'autre à travers Internet : c'est lui qui décide, selon la façon dont les rafraîchissements des deux écrans se croisent, si une image passe à un rafraîchissement ou au suivant. Et les 6 ms que le compositeur de Windows demande avant chaque rafraîchissement seraient plus courtes si l'image allait directement à l'écran sans être composée, ce que rien ne mesure encore.

## D230. Le Wi-Fi reste sur son canal pendant une session, et l'affichage ne se fie plus aux numéros de Windows (2026-09-25, pendant MZ)

**Ce que le troisième journal a montré.** Trente et une secondes à travers Internet, PC-SAV en hôte, le portable en client sur son Wi-Fi, une fenêtre déplacée sans arrêt. L'hôte est réglé : 2,2 ms d'encodage par image au lieu de 7,5, le pilote NVIDIA ayant gardé la carte à pleine vitesse dès la première session ([D229](#d229-la-carte-de-lhôte-reste-à-pleine-vitesse-et-laffichage-rend-la-latence-que-la-cadence-avait-prise-2026-09-25-pendant-mz)). Ce qui reste est côté client, en trois morceaux.

- **Le Wi-Fi du portable.** Treize fois en vingt-deux secondes, à 1,7 s d'intervalle, plus rien n'arrive pendant 130 ms, puis tout arrive d'un coup. Côté hôte, les images partent régulièrement : c'est la carte Wi-Fi qui quitte son canal pour écouter les réseaux voisins, et qui n'entend rien pendant ce temps. Moonlight mettait les cartes Wi-Fi en « mode streaming » pendant ses sessions ; la migration l'avait perdu.
- **La réserve après une coupure.** Selon le nombre d'images lâchées ensemble, il en restait parfois deux en attente, et chaque image suivante arrivait un rafraîchissement en retard jusqu'au rattrapage, deux secondes plus tard. Avec une coupure toutes les 1,7 s, ce retard ne se résorbait jamais.
- **Le compte de Windows.** Pendant une coupure, l'écran du portable, resté sans image nouvelle, saute un numéro dans son compte des rafraîchissements. L'affichage raisonnait sur ces numéros, et se décalait d'un cran quelques images plus tard : un rafraîchissement remontrait l'image d'avant, puis chaque image arrivait un rafraîchissement en retard, 25 ms d'attente au lieu de 8. Cinq ou six images par coupure étaient crues affichées trop tôt, et la durée d'un rafraîchissement était lue 16,9 ms au lieu de 16,67 une seconde sur cinq. Les secondes où l'attente monte à 25 ms sont exactement celles qui suivent une coupure.

**Ce qui change.**

- Pendant toute session, sur les deux ordinateurs, le service demande à chaque carte Wi-Fi connectée de ne plus chercher d'autres réseaux et de passer en mode streaming ([MOTEUR.md](MOTEUR.md), section 3, étape 6). Ce sont deux votes que Windows retire tout seul dès que le service les lâche, même s'il s'arrête brutalement, et qu'il oublie quand la carte se déconnecte : une carte qui se reconnecte pendant la session est redemandée aussitôt. C'est le service qui demande, et non le lecteur, parce que Windows peut refuser ces réglages à un programme qui n'est pas administrateur, et que le service tourne avec le compte système. La bibliothèque Wi-Fi de Windows n'est cherchée qu'au moment de la session : un Windows Server sans Wi-Fi n'en a pas, et le service ne démarrerait plus s'il en dépendait.
- Une image décodée moins d'un quart de rafraîchissement après celle qui attend prend sa place ([MOTEUR.md](MOTEUR.md), section 3, étape 9).
- L'affichage repère chaque rafraîchissement par son heure, plus par le numéro que Windows lui donne. Le nombre de rafraîchissements entre deux mesures se déduit du temps écoulé. Quand le compte de Windows et son horloge ne concordent plus, numéro sauté ou rafraîchissement daté de plus d'un demi-rafraîchissement de travers, rien n'est jugé sur ce qu'il en dit jusque-là : une image à l'heure serait sinon crue en retard, et la fenêtre se fermerait plus tôt pour vingt secondes.

**Ce qui a été pesé sur les vraies arrivées.** Les arrivées des trois journaux, rejouées contre un écran simulé à dix-sept décalages entre les deux écrans. Sur celui-ci, laisser la plus récente prendre la place fait passer le pire cas (95 %) de 47 à 37,5 ms entre capture et écran, et la moyenne de 35,3 à 33,4 ms, pour trois ou quatre sauts de plus en trente secondes. Deux variantes ont été écartées. Laisser aussi la plus récente remplacer l'image déjà présentée pour un rafraîchissement pas encore venu gagne 0,7 ms de plus, mais ajoute des sauts. Reprendre la réserve en une demi-seconde au lieu de deux ajoute des sauts sur les deux premiers journaux, pour presque rien sur celui-ci. Le décalage des numéros est rejoué dans un essai : une coupure pendant laquelle l'écran saute un numéro ne coûte plus ni à-coup, ni retard, ni faux jugement, et la durée d'un rafraîchissement reste juste.
