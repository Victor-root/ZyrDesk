...
**Décision.** Pendant qu'une session tient le clavier, ZyrDesk **réclame** Alt+Tab, Alt+Maj+Tab, Alt+Échap et Ctrl+Échap au système, de la même façon qu'il réclame déjà ses propres raccourcis, et les porte telles quelles à la fenêtre de l'image. Une combinaison réclamée est remise au programme qui l'a demandée au lieu d'être exécutée par le système : le sélecteur de fenêtres de cet ordinateur ne s'ouvre pas du tout. Elles sont rendues dès que le premier plan quitte ZyrDesk. L'option du moteur client qui faisait ça, demandée par [D28](#d28-alt-tab-et-la-touche-windows-agissent-sur-lordinateur-distant-2026-08-23-pendant-m4), est retirée : l'intention de D28 tient, le moyen change.
...
**Réclamer plutôt que guetter, et pourquoi il a fallu essayer l'autre d'abord.** Le premier mécanisme se mettait devant chaque frappe de tout l'ordinateur et attrapait celles-ci au passage. C'est une **course** contre le traitement que le système fait lui-même de ces mêmes touches, et elle était perdue à peu près une fois sur quatre. C'est tout ce qu'était « Alt+Tab marche jusqu'à ce que je touche au bouton flottant » : rien à voir avec le bouton, seulement avec ce qui se passait ailleurs à cet instant. Dit par Victor, quatre fois de suite et à chaque fois à raison : « le alt tab fonctionne mais dès que j'ouvre/ferme le fab il ne fonctionne plus ».

Les compteurs posés pour ça l'ont montré sans ambiguïté : le **relâchement** du Tab arrivait, sans l'appui qui allait avec, répondu « relâchement d'une touche jamais reprise ». L'appui n'avait jamais été présenté à ZyrDesk. Une réclamation n'est pas une course : elle est faite une fois et honorée à chaque fois. Deux tours ont été dépensés à rendre la course plus rapide, dont un à donner à la reprise un fil à elle ; c'était une amélioration réelle et ça n'a pas suffi, parce que le défaut n'était pas la vitesse.

**Le prix d'une réclamation, et ce qui le paie.** Une combinaison réclamée l'est contre l'ordinateur entier, y compris pendant que la personne travaille dans un autre programme. Elles sont donc rendues à l'instant où le premier plan quitte ZyrDesk, sur le message même par lequel le système annonce ce départ, et reprises quand il revient. Attendre le tour suivant de la surveillance de session serait une seconde pendant laquelle l'Alt+Tab de cette personne partirait à l'ordinateur distant.
...
**Ce qui garde ça sûr.** Trois conditions, toutes les trois exigées : une session est à l'écran, le premier plan appartient à cette session, et l'image est bien la fenêtre à qui le clavier va. Faute d'une seule, les combinaisons sont rendues et Windows fait ce qu'il a toujours fait. Tab et Échap seules ne sont jamais réclamées : ce sont des touches ordinaires, et seule la compagnie qu'elles gardent en fait des touches du système.

**Ce que ça coûte.** Plus rien sur le chemin des touches : ZyrDesk ne s'y met plus du tout, il attend qu'on lui remette ce qu'il a réclamé. Si Windows refuse une combinaison, parce qu'un autre programme l'a prise avant, le journal le dit en nombre à la reprise de chaque session, et cette combinaison-là reste celle de cet ordinateur.
