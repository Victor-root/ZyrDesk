...
**Sur un fil à lui, qui ne fait rien d'autre.** Le système appelle ce genre de reprise sur le fil qui l'a demandée, et **chaque frappe de tout l'ordinateur attend cet appel** ; un fil trop occupé pour répondre à temps se voit remettre la touche au système comme s'il n'y avait aucune reprise du tout. Accroché au fil qui dessine, comme il l'était, il manquait une rafale de touches à chaque fois que ce fil avait un instant de travail. Fermer le menu du bouton flottant coûte un message à une fenêtre, un changement de focus et une ligne écrite sur le disque, et les compteurs ont attrapé le prix exact : trois frappes d'affilée absentes du décompte, dont le premier Alt+Tab qui suivait le menu. Dit par Victor : « le alt tab fonctionne mais dès que j'ouvre/ferme le fab il ne fonctionne plus ». Le journal montrait le relâchement du Tab arriver seul, sans l'appui qui allait avec, et répondu « relâchement d'une touche jamais reprise ». Un fil qui ne fait que lire ses messages n'a pas de ces instants-là.
