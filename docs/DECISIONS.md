...
**Ce qui a fait durer ça cinq tours : une condition de trop.** Il était demandé, en plus, que le clavier soit **à l'image** au moment de la touche. Or toucher au bouton flottant donne le clavier à la page de ce bouton, et il met un instant à revenir : une Alt+Tab tapée dans cet instant était refusée et changeait de fenêtre ici. C'est exactement et uniquement ce qu'était « Alt+Tab ne marche plus dès que j'ouvre et ferme le fab », dit par Victor cinq fois de suite et à chaque fois à raison.

Cette condition était fausse deux fois. Elle est celle qui échouait, et elle est hors sujet : ce qui est repris est déposé à la fenêtre de l'image **par son nom**, ce qu'aucun focus ne décide. Une session au premier plan est une session à qui Alt+Tab appartient, menu ouvert ou non. Restent deux conditions, et elles suffisent : il y a une image, et le premier plan est à cette session.

**Sur un fil à lui, qui ne fait rien d'autre.** Le système appelle ce genre de reprise sur le fil qui l'a demandée, et chaque frappe de tout l'ordinateur attend cet appel ; un fil trop occupé pour répondre à temps se voit remettre la touche comme s'il n'y avait aucune reprise. Accroché au fil qui dessine, comme il l'était d'abord, il pouvait manquer une touche à chaque instant de travail de ce fil. Ce n'était pas la cause du défaut ci-dessus, mais c'en était une vraie, et elle est fermée.
