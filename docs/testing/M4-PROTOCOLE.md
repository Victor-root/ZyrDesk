...
>
> **L'image est rangée dans la fenêtre au premier geste d'une session et y reste jusqu'à la fin.** C'est le seul remède à l'éclair, et il ne tient pas à la durée d'une traversée mais à leur nombre. Chacune dure environ une milliseconde et demie contre une image écran de 16,7 ms, soit une chance sur onze d'être dessinée ; il y en avait deux par geste, donc une session de vingt gestes en montrait quatre. Une seule traversée par session, c'est une chance sur onze d'en voir une, jamais.
>
...
>
> Si le clavier ne passe pas, l'application le dit elle-même et se répare : la ligne `une touche est arrivée à la fenêtre de ZyrDesk et non à la session` apparaît dans le journal et l'image ressort aussitôt de la fenêtre, avec le va-et-vient d'avant et l'éclair avec. Une session n'est donc jamais laissée sans clavier. L'absence de cette ligne ne prouve rien à elle seule, en revanche : une touche prise par la vue web sous l'image ne remonte pas jusqu'ici non plus. Seul l'essai à la main tranche.
>
