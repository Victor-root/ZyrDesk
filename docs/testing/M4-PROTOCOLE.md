...
>
> Et l'ordre des deux mouvements. Déplacer notre fenêtre ne coûte rien, elle est à nous ; déplacer l'image coûte une attente sur un autre programme, de l'ordre de la milliseconde. Faits dans cet ordre, cette milliseconde est une milliseconde pendant laquelle le cadre a bougé et l'image pas, et Windows dessine ce qu'il trouve : une bande de la page le long du bord vers lequel la fenêtre va. L'image est donc posée **d'abord**, sur l'intérieur que la fenêtre est sur le point d'avoir, et la fenêtre suit dans le même message. L'attente tombe alors avant que quoi que ce soit ait bougé.
>
