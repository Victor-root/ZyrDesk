...
| **R66** | **Nouveau, et c'est la réponse à ce que D97 laissait ouvert.** Le bord du bouton flottant est lisse, y compris sur un fond blanc. Il était en escalier parce que la fenêtre est découpée à un masque d'un bit par pixel et qu'une fenêtre opaque a forcément un bord dur. La transparence par pixel était demandée à moitié : il manquait de déclarer la fenêtre *layered* avec une opacité constante de 255. La couleur de fond part avec, les deux s'excluant, et un pixel pas encore peint ne montre plus rien au lieu de montrer du blanc |
...
>
> Attendu : le contour noir du logo est **lisse**, sans marches d'escalier, et il n'y a **ni plaque ni liseré** d'aucune couleur autour. Ce qu'on voyait avant : un contour en escalier, très visible sur du blanc.
>
...
>
> **S'il reste une marche très fine** sur les coins arrondis alors que tout le reste est bon : c'est la découpe qui rogne le dernier pixel lissé, et la suite est de l'élargir d'un pixel. À dire, ça se corrige en une ligne.
