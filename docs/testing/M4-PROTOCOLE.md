...
>
> **À regarder aussi à l'ouverture et à la fermeture du menu**, qui sont les moments où la découpe est refaite : rien de blanc ne doit apparaître autour de la carte qui s'ouvre, ni à la place qu'elle occupait quand elle se referme.
>
...
>
> **Et le test qui sépare le net du mou** : regarder le bouton la souris **loin de lui**, puis la souris **posée dessus**, puis **bouton enfoncé**. Les trois doivent être aussi nets l'un que l'autre, parce que c'est le **même dessin à la même taille** dans les trois cas.
>
> **Le logo ne change plus de taille, et c'est ça qu'on vérifie.** Passer la souris dessus : il devient franc, il ne grossit pas. Appuyer : le curseur devient une main qui agrippe, il ne rétrécit pas. **S'il grandit, la correction a été perdue.** Mesuré sur le dessin lui-même à 125 % : à sa taille de repos, 52 % des bords droits du contour sont un noir franc ; agrandi de six pour cent, il en reste 2 %. Le dessin est vectoriel mais l'écran est une grille, et 55 pixels réels sur les 440 du dessin tombent juste, un huitième, là où 58,3 tombent n'importe où.
>
> **Ce que le journal en dit**, et c'est là qu'il faut regarder si ça ne va toujours pas. Trois choses, et **chacune ne se dit que quand elle change**, pour ne pas se noyer les unes les autres.
>
> Une ligne par morceau : `dessiné LxH en (…) coins …, contour … px ; découpé (…) coins … ; marges g … h … d … b …, dans le coin …`. Les cinq marges doivent être **positives**, c'est-à-dire la découpe en dehors du dessin. Une seule négative est le pochoir qui coupe dans le dessin, et c'est ce qui se voit comme un bord en escalier. Le `dessiné LxH` doit rester le **même nombre** pendant toute la session, souris posée ou pas : s'il en donne deux, le logo change de taille et le contour se dégrade à chaque fois qu'il n'est pas au repos.
>
