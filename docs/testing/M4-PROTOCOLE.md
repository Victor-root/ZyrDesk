...
>
> **Ce qui a été mesuré sur l'image que Victor a filmée**, gardée à [`captures/bouton-flottant-liseret-gauche.png`](captures/bouton-flottant-liseret-gauche.png). Deux choses s'y voient et une seule est un défaut. La tache blanche ronde sur le coin bas droit de l'écran or est **le pointeur de la souris**, la main fermée que la page demande pendant qu'on tient le logo ; aucune copie de fenêtre ne la prend, d'où deux archives où elle manquait. Le défaut est **un liseré pâle large de deux pixels le long du bord gauche, dehors**, à 203,209,216, là où la même marge vaut 5,8,15 en haut, 6,9,15 à droite et 8,11,15 en bas. C'est exactement le pixel que la découpe prend au-delà de ce que la page peint, et c'est le seul endroit de cette fenêtre que la page ne peint pas.
>
