...
>
> **Et si l'artefact est encore là, ce sont les photos qu'il faut envoyer.** Le bouton se photographie à l'ouverture du menu et à chaque changement de taille de sa fenêtre : le journal dit `bouton flottant photographié dans …`, et les fichiers `bouton-1.bmp` à `bouton-8.bmp` sont dans le dossier des journaux. Ils sont **recopiés de l'écran**, donc ils portent ce que l'oeil voit, découpe et compositeur compris. Ils l'étaient auparavant en demandant à la fenêtre de se redessiner, ce qui ne montre jamais qu'une page juste : deux archives sont revenues vides pour cette seule raison.
>
...
>
> **Et une leçon sur l'instrument, à ne pas réapprendre** : les photos que le bouton prend de lui-même sont **aveugles à ce défaut-là**. Vingt-quatre, dont six pile au bon instant, montraient un bouton irréprochable pendant que l'oeil voyait la bande. Ce qu'un compositeur ajoute au moment de composer n'est pas dans ce qu'on recopie de l'écran. Pour cette famille de défauts, c'est une capture d'écran de Victor qui fait foi, pas les `bouton-*.bmp`.
>
> **Et si c'est encore là, c'est la photo `la découpe venait de s'agrandir` qu'il faut envoyer.** Les onze premières photos de ce bouton étaient toutes irréprochables pendant que l'oeil voyait un éclair, et la raison est bête : elles étaient prises **à l'instant même de la découpe**, une milliseconde après avoir posé la forme, alors que ni le compositeur ni la page n'avaient encore bougé. Une photo est maintenant prise au **début de l'appel suivant**, c'est-à-dire une image plus tard, quand l'écran montre enfin ce que la découpe a fait, et seulement quand la découpe **grandit**, puisqu'une découpe qui rétrécit ne peut que cacher des pixels déjà peints. Une seule par mouvement de souris, la première d'une série : la découpe grandit à chacune des sept images de l'animation et sept copies de l'écran par passage de main se paieraient sur la session.
>
